...
<div class="table-wrapper row container">
  <form class="woocommerce-cart-form col s12 m12 l9 xl9" action="<?php echo esc_url( wc_get_cart_url() ); ?>"
    method="post">
    ...
    <div class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
      <div class="table-head">
        <div class="table-row">
          ...
          <span class="product-quantity"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></span>
          <span class="product-subtotal"><?php esc_html_e( 'Subtotal', 'woocommerce' ); ?></span>
        </div>
      </div>
        ...
        <?php
			foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					?>
        <div
          class="table-row <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
  ...
  <div class="cart-collaterals col s12 m6 l3 xl3">
    <?php
		/**

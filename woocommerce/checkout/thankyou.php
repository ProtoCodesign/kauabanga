...
<div class="woocommerce-order">
  ...
  <div class="table-head"><span><?php _e( 'Detalhes do pedido', 'kauabanga' ); ?></span></div>

  <ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">

    <li class="woocommerce-order-overview__order order table-row">
    ...
    <li class="woocommerce-order-overview__date date table-row">
    ...
    <li class="woocommerce-order-overview__email email table-row">
    ...
    <li class="woocommerce-order-overview__phone phone table-row">
      <strong><?php _e( 'Telefone:', 'kauabanga' ); ?></strong>
      <span><?php echo esc_html( $order->get_billing_phone() ); ?></span>
    </li>
    <?php endif; ?>

    <?php if ( $order->get_payment_method_title() ) : ?>
    <li class="woocommerce-order-overview__payment-method method table-row">
      <strong><?php esc_html_e( 'Payment method:', 'woocommerce' ); ?></strong>
      <span><?php echo wp_kses_post( $order->get_payment_method_title() ); ?></span>
    </li>
    <?php endif; ?>

    <li class="woocommerce-order-overview__total total table-row">

...
<h2>
  <?php echo apply_filters( 'woocommerce_my_account_my_orders_title', esc_html__( 'Recent orders', 'woocommerce' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
</h2>
...
<div class="shop_table shop_table_responsive my_account_orders">
  ...
  <div class="table-row">
    ...
    <div class="<?php echo esc_attr( $column_id ); ?>">
      <p class="nobr"><?php echo esc_html( $column_name ); ?></p>
    </div>
    <?php endforeach; ?>
  </div>
  ...
  <div class="order">
    <?php foreach ( $my_orders_columns as $column_id => $column_name ) : ?>
    <div class="table-row <?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">

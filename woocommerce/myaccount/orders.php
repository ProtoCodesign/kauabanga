...
<div
  ...
  <div class="table-head table-head-orders">
    <?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
    <span
      class="table-column woocommerce-orders-table__header woocommerce-orders-table__header-<?php echo esc_attr( $column_id ); ?>">
  ...
  <?php
			foreach ( $customer_orders->orders as $customer_order ) {
				...
				?>
  <div
    class="table-row woocommerce-orders-table__row woocommerce-orders-table__row--status-<?php echo esc_attr( $order->get_status() ); ?> order">
    <?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
